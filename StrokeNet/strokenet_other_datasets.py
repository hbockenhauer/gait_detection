...
from ElderNet.eldernet_WearGait import load_weargait_data, detect_sampling_rate
from ElderNet.eldernet_ADL import extract_subject_id_and_timestamp

# --- CONFIGURATION ---
DATASETS_ROOT = os.path.join(PROJECT_ROOT, 'Datasets')

ADL_PATH = os.path.join(DATASETS_ROOT, 'HMP_Dataset')
WISDM_PATH = os.path.join(DATASETS_ROOT, 'wisdm-dataset', 'raw', 'watch', 'accel')
WEARGAIT_PD_PATH = os.path.join(DATASETS_ROOT, 'WearGait', 'WearGait-PD')
WEARGAIT_CTRL_PATH = os.path.join(DATASETS_ROOT, 'WearGait', 'WearGait-Ctrl')
BIOCLITE_PATH = os.path.join(DATASETS_ROOT, 'Bioclite', 'data_6activities_plain.mat')
WEIGHTS_PATH = os.path.join(SCRIPT_DIR, 'eldernet_finetuned.pth')
PLOTS_DIR = os.path.join(SCRIPT_DIR, 'StrokeNet_Plots')
