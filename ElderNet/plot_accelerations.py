...
from eldernet_owndata import prepare_windows_overlapping, resample_to_30hz,apply_bout_constraints, set_seed
from eldernet_owndata import CONF_THRESH, MIN_ENERGY, MAX_ENERGY, MIN_FREQ, MAX_FREQ, WINDOW_SIZE, STEP_SIZE, REPO_NAME, GAIT_CLASSES, SAMPLE_RATE_QSENSE 
        ...
        for file in files:
            ...
            try:
                ...
                if right_df is not None and left_df is not None:
                    ...
                    # save to disk
                    save_path = os.path.join(DATASET_PATH, "Plots", f"{folder}_raw_acceleration.png")
