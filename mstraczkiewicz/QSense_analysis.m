...
for d = 1:length(dataPaths)
    ...
    for i = 1:length(subDirs)
        ...
        plotData = struct(); % Collect data for the paired plot
        ...
        for t = 1:size(targetFiles, 1)
            ...
            try
                ...
                % Store metrics for the paired plot
                plotData.(sideLabel).T_vec = T_vec;
                plotData.(sideLabel).peakF = peakF;
                plotData.(sideLabel).ampVal = ampVal;
...
if ~isempty(summaryResults)
    ...
    fprintf('\n======================================================================\n');
    fprintf('GLOBAL PERFORMANCE (Combined All Folders)\n');
    fprintf('----------------------------------------------------------------------\n');
    fprintf('Accuracy:  %.4f\n', globalAcc);
