...
for i = 1:length(allFiles)
    ...
    try
        ...
        dataQuality = [dataQuality; table({subject}, {fileName}, ...
            ...
            'VariableNames', {'Subject','File','TotalSec','ValidSec','RemovedSec','RemovedPct'})];
...
if ~isempty(summaryResults)
    ...
    fprintf('TOTAL removed:    %.1f s (%.1f%%)\n', totalRemSec,   100 * totalRemSec   / totalRecSec);
    fprintf('======================================================================\n');
    ...
    try
        ...
        save(fullfile(plotPath, 'Emergency_Backup.mat'), 'summaryResults', 'subjectSummary', 'dataQuality');
    end
end
